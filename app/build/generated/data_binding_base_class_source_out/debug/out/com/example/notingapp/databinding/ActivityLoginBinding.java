...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView goSignUp;
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull EditText emailInput,
      @NonNull TextView goSignUp, @NonNull Button loginBtn, @NonNull EditText passwordInput) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.goSignUp;
      TextView goSignUp = ViewBindings.findChildViewById(rootView, id);
      if (goSignUp == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, emailInput, goSignUp, loginBtn,
          passwordInput);
    }
